...
const success = ({ products }: Props) => {
  ...
  return (
    <div>
      <Head>
        <title>Thank You! - Apple | Vj</title>
        <link rel="icon" href="/apple.png" />
      </Head>
      <header className="mx-auto flex max-w-xl items-center justify-center">
        <Link href="/">
            ...
            >
              <div className="mx-auto flex max-w-xl items-center justify-between px-4 py-6">
                ...
                <p className="text-xl font-medium text-black">
                  <Currency currency="INR" quantity={subtotal + 1621.73} />
                </p>
              </div>
            </div>
                ...
                <div className="space-y-1 py-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      <Currency currency="INR" quantity={subtotal} />
                    </p>
                  </div>
                  <div className="flex justify-between text-sm">
                  ...
                  <div className="flex justify-between text-sm">
                    ...
                    <p className="font-medium">
                      <Currency quantity={1621.73} currency="INR" />
                    </p>
                  </div>
                </div>
